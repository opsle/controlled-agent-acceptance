...
- Run identity is non-reusable.
- The exact provider budget is literal.
- Pause restoration is interruption- and restart-safe.
- Harness verdict and system-under-test verdict remain distinct.
